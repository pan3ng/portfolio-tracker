 ...
 *
 * This is used in middleware.ts to check authentication status and
 * refresh user sessions. The cookie handling here is different from
 * Server Components because middleware needs to update the response.
 */
