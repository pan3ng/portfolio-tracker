  ...
  if (holdings.length === 0 && recentTransactions.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-900">Welcome to Portfolio Tracker</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
            ...
            <div className="text-center">
              <p className="text-xs font-medium text-gray-600 flex items-center justify-center gap-1">
                Uninvested
                <span className="text-gray-400" title="Cash not yet invested in shares">ⓘ</span>
              </p>
              <p className={`mt-1 text-lg font-bold ${
                uninvestedCapital >= 0 ? 'text-purple-600' : 'text-red-600'
              }`}>
            ...
            <div className="text-center">
              <p className="text-xs font-medium text-gray-600">Market P/L</p>
              <p className={`mt-1 text-lg font-bold ${
